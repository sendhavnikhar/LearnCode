                ...
                <div class="col-md-20">
                    <table class="table table-dark table-striped">
                        ...
                        <tr>
                            ...
                            <th class="text-center">CoursePrice</th>
                            <th class="text-center">CourseDetail</th>
                            
                            <th class="text-center">CoursePic</th>
                        </tr>
                        </thead>
                        ...
                        <% for (Course course : CourseList) { %>
                            <tr>
                                <td class="text-center"><%= course.getCourseId() %></td>
                                <td class="text-center"><%= course.getCourseName() %></td>
                                <td class="text-center"><%= course.getCoursePrice() %></td>
                                <td class="text-center"><%= course.getCourseDetails() %></td>
                               
                                
                               <td class="text-center"><button name="btn"  class="btn btn-primary" value="<%=course.getCourseName() %>">Delete </button></td>
